      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8">
          <div className="text-center md:text-left">
            ...
            <p className={`${roboto.className}`}>✉️ shovasatkira88.com</p>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex sm:flex-row items-center justify-center md:justify-start">
              <input type="email" placeholder="Email" className={`p-2 rounded-l md:w-full w-full sm:w-3/4 ${roboto.className}`} />
              <button
                onClick={() => router.push('#')}
                className="bg-[var(--trevland-red)] hover:bg-red-600 text-white font-bold py-2 px-4 rounded-r sm:rounded-l-none"
              >
                Send
              </button>
            </div>
