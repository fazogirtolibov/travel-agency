  ...
  return (
    <header id="header" className="text-white">
      ...
      <div className="relative w-full h-[100vh] flex flex-col">
        ...
        <div className="top-0 left-0 w-full bg-[var(--trevland-gray)] z-50"> {/* fixed qilmadim chunki designga to'gri kelmayapti scroll down qilganda */}
          <div className="p-6">
            <div className="container m-auto px-4 sm:px-6 md:px-12 flex justify-between items-center relative z-10">
        ...
        {/* Hero Section */}
        <div className="flex-1 flex flex-col justify-center items-center sm:items-start max-w-3xl sm:px-6 md:px-8 mx-30 my-0">
